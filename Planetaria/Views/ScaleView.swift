                    ...
                    VStack {
                        ZStack {
                            ...
                            if let derivativeScale {
                                Capsule()
                                    .fill(LinearGradient(colors: [color.opacity(0.9), .clear], startPoint: derivativeScale > 0 ? .trailing : .leading, endPoint: derivativeScale > 0 ? .leading : .trailing))
